...
[Click to download](./MiroPythom_Resource.7z) 
...
### 1.2 Compiler Setup and Toolbar Introduction
...
### 1.5 Download Code to Micro:bit
...
![](./media/image-20250422103137627.png)
...
| display.show(Image.HEART)       | LED dot matrix displays![](./media/image-20250421144625274.png) |
| sleep(500)                      | Delay in 500ms                                               |
| display.show(Image.HEART_SMALL) | LED dot matrix displays![](./media/image-20250421144739465.png) |

#### 2.1.5 Test Result

Upload the code to the micro:bit and plug in it via a USB cable, then the LED dot matrix displays![](./media/image-20250421144625274.png)and ![](./media/image-20250421144739465.png)

If download unsuccessfully, disconnect the micro:bit and reboot it

![](./media/image-20250421144923855.png)

#### 2.1.6 Expanded Knowledge

You can see that "Image.HEART" is equal to![](./media/image-20250421144625274.png);Image.HEART_SMALL" is

equal to![](./media/image-20250421144739465.png)This is actually written in microbit, you can directly use it. 
...
![](./media/image-20250421145236833.png)
...
![](./media/image-20250422103220685.png)
...
“3”,“4”,“5”,“↓”,“hello!”,“❤”,![](./media/image-20250421152155979.png),![](./media/image-20250421152220664.png),![](./media/image-20250421152234127.png),![](./media/image-20250421152248864.png)patterns. Each interval is 500ms.
...
![](./media/image-20250421155923137.png)
...
![](./media/image-20250422103909589.png)
...
![](./media/image-20250421160057339.png)

------

![](./media/image-20250422104011896.png)
...
**Test Result：**Upload the`2.5- Temperature Measurement -2.py` plug in micro:bit via USB cable, when the ambient temperature is less than 35℃, 5*5LED will show![](./media/image-20250421144739465.png). When the temperature is equivalent to or greater than 35℃, the pattern ![](./media/image-20250421144625274.png) will appear.
...
| sleep(500)                                                   | Delay in 500ms                                               |
| **if** temperature() >= 35:<br/>display.show(Image.HEART)<br/>**else**:<br/>display.show(Image.HEART_SMALL) | If temperature value ≥35℃ <br/>micro:bit shows“ ![image-20250421144625274](./media/image-20250421144625274.png)”<br/>If temperature value<35℃<br/>micro:bit displays“![](./media/image-20250421144739465.png) ” |
...
The calibration is finished until you view the smile pattern ![](./media/image-20250421161134812.png). 
...
![](./media/image-20250422104445029.png)
...
![](./media/image-20250421162007492.png)

When the logo is down, the number 3 is displayed:

![](./media/image-20250421162024677.png)

When the screen is up, the number 4 is shown.

![](./media/image-20250421162042549.png)
...
![](./media/image-20250422110200447.png)
...
![](./media/image-20250421162244887.png)
...
![](./media/image-20250422083733607.png)
...
![](./media/image-20250422110354381.png)
...
![](./media/image-20250422110925569.png)
...
![](./media/image-20250422091610310.png)
...
![](./media/image-20250422094016614.png)
...
![](./media/image-20250422112539411.png)
...
![](./media/image-20250422094513295.png)
...
![](./media/image-20250422112729480.png)
...
![](./media/image-20250422094613313.png)

#### 3.3.5 Flow Chart

![](./media/image-20250422094742219.png)
...
![](./media/image-20250422112651718.png)
...
![](./media/image-20250422100310394.png)
...
![](./media/image-20250422100457215.png)
...
![](./media/image-20250422113103074.png)
...
![](./media/image-20250422100935704.png)
...
![](./media/image-20250422113611750.png)
